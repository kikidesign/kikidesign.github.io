...
要完成本教程，您需要一个[GitHub.com帐号]:https://github.com/ 和接入互联网。您不需要知道如何编码，使用命令行，或者安装Git（GitHub是基于Git版本控制软件）。
...
通过在您的拉请求消息中使用GitHub的[@mention提示系统]:https://help.github.com/articles/about-writing-and-formatting-on-github/#text-formatting-toolbar ，您可以要求某个人或团队的反馈，无论他们是在大厅或10个时区之外。
...
提示：您可以使用的[emoji表情符号]:https://help.github.com/articles/basic-writing-and-formatting-syntax/#using-emoji 和[拖放图片、GIF]:https://help.github.com/articles/file-attachments-on-issues-and-pull-requests/ 到提交和拉请求。
...
看看你的GitHub个人资料，你会看到你的[新贡献方块图]:https://help.github.com/articles/viewing-contributions-on-your-profile-page/ （一种用方块颜色展示代码贡献频率的图表）！


如果您想了解更多关于拉请求的内容，我们建议您阅读[GitHub的流程指南]:https://guides.github.com/introduction/flow/。你也可以访问[GitHub的探索页面]:https://github.com/explore 并参与一个开源项目<img class="emoji" title=":octocat:" alt=":octocat:" src="https://assets.github.com/images/icons/emoji/octocat.png" height="20" width="20" align="absmiddle">


提示：检查我们的其他[指南]:https://guides.github.com/ 和[YouTube频道]:https://www.youtube.com/c/githubguides 以了解更多的GitHub入门指南。
